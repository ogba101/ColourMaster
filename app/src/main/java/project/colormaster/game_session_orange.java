...
public class game_session_orange extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.game_session_orange);
    ...
    t1=new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
        ...
        TextView tx = (TextView)findViewById(R.id.thinkTxt_orange);
