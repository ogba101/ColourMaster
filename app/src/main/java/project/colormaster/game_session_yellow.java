...
public class game_session_yellow extends AppCompatActivity {
    TextToSpeech t1;
    float pitch=(float)(1);
    float rate=(float)(1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.game_session_yellow);
        ...
        TextView tx = (TextView)findViewById(R.id.thinkTxt_yellow);
